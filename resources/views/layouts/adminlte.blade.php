...
<head>
  ...
  <title>PETA PARIWISATA | Dashboard</title>
...
<body class="hold-transition skin-blue sidebar-top-nav">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="{{url('/')}}" class="logo">
        ...
        <span class="logo-lg"><b>Peta</b>Pariwisata</span>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="image">
            <img src="{{asset('img/SmartRT-100.png')}}" class="img-circle" alt="User Image">
          </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview {{Request::is('setting')?'active':''}}">
            ...
            <ul class="treeview-menu">
              <li class="{{Request::is('setting')?'active':''}}"><a href="{{url('setting')}}">Google API Peta</a></li>
            </ul>
          </li>
          <li>
            <a href="{{ route('logout') }}"
    ...
    <footer class="main-footer">
      <img src="{{asset('img/SmartRT-Resize.png')}}" width="30" height="30">
      <!-- To the right -->
      <div class="pull-right hidden-xs">
        Peta Wisata
      </div>
      <!-- Default to the left -->
      <strong>Copyright &copy; 2020 <a href="blank">Peta Wisata</a>.</strong> All rights reserved.
    </footer>
